(_this select 1) setVariable ["AGM_Medical_fnc_isMedic",true];
...
(_this select 1) addVest "rhsusf_iotv_ucp_medic";
(_this select 1) addBackpack "rhsusf_assault_eagleaiii_ocp_medic";
